...
from lianxi2.utils import mydb
...
class RandomUserAgent(object):      #继承object
    ...
    def process_request(self,request,spider):
        ua = getattr(self.ua,self.crawler.settings['UA_TYPE'])  #获取属性，生成浏览器标识
...
class Lianxi2SpiderMiddleware(object):
...
class Lianxi2DownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
