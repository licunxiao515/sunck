import requests
from scrapy_66daili.utils import mydb
from scrapy_66daili import settings
...
class ProxyManager(threading.Thread):       #集成多线程
    ...
    def drop_proxy(self,proxy):
        ...
        sql = "delete from spiderip where host=%s"
        #执行
